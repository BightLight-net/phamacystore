...
public class adminRegister extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (result) {
            JOptionPane.showMessageDialog(null, "The account has been created.", "Great!", JOptionPane.INFORMATION_MESSAGE);          
            clearForm();
        }
    }//GEN-LAST:event_jButton1ActionPerformed

    private void signOutButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signOutButtonActionPerformed
        int confirm = JOptionPane.showConfirmDialog(null, "Are you sure you want to sign out?", "Thank you for using Our Portal", JOptionPane.YES_NO_OPTION);
